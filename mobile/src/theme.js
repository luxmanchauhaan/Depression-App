...
// Same palette family, but each card gets its own identity so the grid
// is easier to scan instead of every icon being the same green.
export const menuColors = {
  moodCheckIn: { bg: '#E1E7FB', icon: '#6C7FD6' },
  questionnaire: { bg: '#DFF5E3', icon: '#5FAE7B' },
  activities: { bg: '#FDEBD3', icon: '#E0A458' },
  myHistory: { bg: '#DCEEFB', icon: '#4C9BD6' },
  sleepLog: { bg: '#F3DCF7', icon: '#B366C9' },
  weightLog: { bg: '#FDE0E0', icon: '#E07A7A' },
  medicineReminders: { bg: '#E6E9FB', icon: '#7B84D6' },
  patientList: { bg: '#DFF5E3', icon: '#5FAE7B' },
};